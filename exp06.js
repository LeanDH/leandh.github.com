...
{
	$(".ui-p1-cont2").hide();
	$(".ui-p1-box").click(function(e){
		$(".ui-p1-bigger").attr("src",$(this)[0].src);
		$(".ui-p1-cont2").show();
	});
	...
	$(".ui-p3-button").click(function(){
		cnt=cnt+1;
		if(cnt==1)
			$(".ui-p3-button").before("<div class='ui-p3-box'><div class='ui-p3-box-lab'></div><div class='ui-p3-box-button'>Detele</div></div>");
		else
